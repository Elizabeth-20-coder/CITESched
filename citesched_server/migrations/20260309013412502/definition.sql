...
--
-- Class Faculty as table faculty
--
...
--
-- Class FacultyAvailability as table faculty_availability
--
...
-- Indexes
CREATE UNIQUE INDEX "section_unique_idx" ON "section" USING btree ("program", "yearLevel", "sectionCode", "academicYear", "semester");
...
--
-- Class Timeslot as table timeslot
--
...
--
-- Foreign relations for "faculty_availability" table
--
ALTER TABLE ONLY "faculty_availability"
    ADD CONSTRAINT "faculty_availability_fk_0"
...
--
-- Foreign relations for "schedule" table
--
...
--
-- Foreign relations for "student" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('citesched', '20260309013412502', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260309013412502', "timestamp" = now();
